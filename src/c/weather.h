...
void store_weather_values(int temp_val, int max_val, int min_val, int weather_val, int speed_val, int direction_val, int sunrise_val, int sunset_val, char *ltc);
